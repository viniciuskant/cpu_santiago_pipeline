...
module top_tb_completo ();
  ...
  test_instr_t test_program[NUM_TESTS] = '{
    ...
    '{2'b00, 2'b01, SUB, 8'd5, 8'd3, 8'd8,               8'd0,  8'd2, 1'b0, 1'b0},
    '{2'b00, 2'b01, SUB, 8'd3, 8'd5, 8'd0,               8'd255,  8'd254, 1'b0, 1'b0},
    '{2'b00, 2'b01, MUL, 8'd7, 8'd6, 8'd8,               8'd0,  8'd42, 1'b0, 1'b0},
    ...
    '{2'b11, 2'b10, SUB, 8'd255, 8'd0, 8'd10,              8'd255,  8'd255, 1'b0, 1'b1},
    ...
    '{2'b00, 2'b11, ADD, 8'd7, 8'd255, 8'd0,               8'd0,  8'd12, 1'b0, 1'b0},
    '{2'b00, 2'b10, STORE, 8'd128, 8'd0, 8'd0,               8'd0,  8'd0, 1'b0, 1'b0},
    '{2'b10, 2'b10, LOAD, 8'd0, 8'd255, 8'd128,               8'd0,  8'd12, 1'b0, 1'b0},
    ...
    '{2'b10, 2'b10, LOAD, 8'd255, 8'd0, 8'd2,               8'd0, 8'd0, 1'b0, 1'b0},
