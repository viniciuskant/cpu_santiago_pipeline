module ALU #(
    ...
    assign sin1 = signed'(in1);
    assign sin2 = signed'(in2);

    always_comb begin
        if (nvalid_data == 1'b0) begin
            case (op)
                4'b0000: out = sin1 + sin2;
                4'b0001: out = sin1 - sin2;
                4'b0010: out = sin1 * sin2;
                4'b0011: out = (zero_in2) ? -1 : sin1 / sin2;
                default: out = {4'h0, in2};
            endcase
        end else begin
            out = -1;
        end
